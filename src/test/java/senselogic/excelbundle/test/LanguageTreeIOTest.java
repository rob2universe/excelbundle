...
public class LanguageTreeIOTest extends TestCase
{
	...
	public void testRightBundles()
	{
		...
		assertEquals(
				"Path is not resources\\senselogic\\excelbundle\\test\\test",
				"\\resources\\senselogic\\excelbundle\\test\\test",
				info.getPath());
	...
	public void testLoadLanguage() throws IOException
	{
		LanguageFile file = langTree.loadLanguageFile(
				"resources/senselogic/excelbundle/test/test", "en");
		assertEquals("Incorrect language", "en", file.getLanguage());
		assertEquals(
				"Incorrect path", "resources/senselogic/excelbundle/test/test",
				file.getPath());
